...
class Config:
    ...
    MODULES = [
        ...
        {'name': 'SuperPivotWPS', 'file': 'src/modules/superPivot_WPS_测试.js', 'id': 4},
        {'name': 'PerformanceTest', 'file': 'src/modules/superPivot_性能测试.js', 'id': 5},
        {'name': 'CellLog', 'file': 'src/modules/jsa_log_cell.js', 'id': 6},
        {'name': 'FileLog', 'file': 'src/modules/jsa_log_file_macos.js', 'id': 7},
        {'name': 'MergeTest', 'file': 'src/modules/jsa_merge_test.js', 'id': 8},
        {'name': 'Module6', 'file': 'src/modules/Module6.js', 'id': 9},
        {'name': 'LogExporter', 'file': 'src/modules/jsa_log_exporter.js', 'id': 10},
        {'name': 'LogFile', 'file': 'src/modules/jsa_log_file.js', 'id': 11},
        {'name': 'LogHook', 'file': 'src/modules/jsa_log_hook.js', 'id': 12},
        {'name': 'LogSimple', 'file': 'src/modules/jsa_log_simple.js', 'id': 13},
        {'name': 'LogUtil', 'file': 'src/modules/jsa_log_util.js', 'id': 14},
    ]
